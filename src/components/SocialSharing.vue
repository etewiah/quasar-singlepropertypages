    ...
    <div class="mt-6 flex justify-center">
      ...
      <div class="q-px-md">
        <a
          ...
          target="_blank"
          rel="nofollow noreferrer"
          :href="`//www.linkedin.com/shareArticle?mini=true&url=${urlToShare}&socialSharingTitle=${socialSharingTitle}`"
        >
          <q-icon
            :name="mdiLinkedin"
            class="text-white"
...
export default {
  ...
  computed: {
    // socialSharingTitle() {
    //   return this.currentListingData.listing.socialSharingTitle || "Have a look at this:"
    // },
    urlToShare() {
      let origin = ""
